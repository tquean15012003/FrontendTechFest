...
import CompanyViewApplicant from './pages/Home/CompanyHome/CompanyViewApplicant';
  ...
  return (
    <Fragment>
      <Routes>
        ...
        <Route path='/companyviewapplicantdraft' element={<CompanyHomeTemplate Component={CompanyViewApplicant} />} />
