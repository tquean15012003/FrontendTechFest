    ...
    return (
        <section className="m-5 text-gray-600 body-font px-8 py-5 flex flex-col place-self-center border-b">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                <h2 className="mr-5 text-2xl font-bold title-font text-white">EXPERIENCE</h2>
                <button style={{backgroundColor: "#5a00b1"}} className="flex space-x-3 items-center px-2 py-2 bg-blue-500 hover:scale-110 duration-500 rounded-full" data-bs-toggle="modal" data-bs-target="#experienceModal">
                ...
                <div className="-my-8 divide-y-2 divide-gray-100">
                    <div className="py-8 flex flex-wrap md:flex-nowrap">
                        <div className="md:w-96 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                            <span className="font-semibold title-font text-white text-2xl">Software Engineer Intern</span>
                            <span className="text-white">Jan 2022 — May 2022</span>
                            <span className="text-lg font-semibold text-green-500">Verified</span>
                        </div>
                        <div className="md:flex-grow">
                            <h2 className="text-2xl font-semibold text-white title-font mb-2">Apple</h2>
                            <p className="leading-relaxed text-base text-white">Intern in year 3 to gain experience from Apple.</p>
                            <a style={{color: "#5a00b1"}} className="cursor-pointer text-xl inline-flex items-center mt-4">Edit
                    ...
                    <div className="py-8 flex flex-wrap md:flex-nowrap">
                        <div className="md:w-96 md:mb-0 mb-6 flex-shrink-0 flex flex-col">
                            <span className="font-semibold title-font text-white text-2xl">Undergraduate Researcher</span>
                            <span className="text-white">Jan 2022 — May 2022</span>
                            <span className="text-lg font-semibold text-green-500">Verified</span>
                        </div>
                        <div className="md:flex-grow">
                            <h2 className="text-2xl font-semibold text-white title-font mb-2">NTU-NLP Research Group</h2>
                            <p className="leading-relaxed text-base text-white">Researching on summary generation and question answering based on chart input without underlying data table and conducted literature review for chart information reasoning such as PlotQA.
                                Published a paper as co-author on ACL 2022.</p>
                            <a style={{color: "#5a00b1"}} className="cursor-pointer text-xl inline-flex items-center mt-4">Edit
                                <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M11 5H6a2 2 0 00-2 2v11a2 2 0 002 2h11a2 2 0 002-2v-5m-1.414-9.414a2 2 0 112.828 2.828L11.828 15H9v-2.828l8.586-8.586z" />
                                </svg>
